...
//        VolumeChangeListener { volume -> LogUtil.d(TAG, "volume test : $volume") }
...
//    override fun onDialogSelectedClick(dialog: DialogFragment, value: String) {
//        val text = supportFragmentManager.findFragmentById(R.layout.fragment_main)
//        // 프래그먼트 UI에 직접 접근한다.
//
//
//    }
